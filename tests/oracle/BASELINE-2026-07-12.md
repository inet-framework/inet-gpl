...
- message: Datagrams are not the same -- in module (inetgpl::PacketDrillApp) OracleTcpHost.pdhost.tunApp[0] (id=16), at t=1.02s, event #27
...
- message: Datagrams are not the same -- in module (inetgpl::PacketDrillApp) OracleTcpHost.pdhost.tunApp[0] (id=16), at t=1s, event #15
- unmapped knobs (possible attribution): net.ipv4.tcp_congestion_control=cubic, --tcp_ts_tick_usecs=1000, --tolerance_usecs=7000
...
- message: Datagrams are not the same -- in module (inetgpl::PacketDrillApp) OracleTcpHost.pdhost.tunApp[0] (id=16), at t=1.1s, event #28
