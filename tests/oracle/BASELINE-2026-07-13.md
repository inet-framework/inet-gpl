...
Kernel: `7.1.1`  
INET commit: `ab1268319706`  
INETGPL commit: `47afcf838eaa`  
...
- kernel source hint: `~/w/kernel/linux-7.2-rc2/net/ipv4/tcp_input.c, ~/w/kernel/linux-7.2-rc2/net/ipv4/tcp_recovery.c`
- message: Datagrams are not the same -- in module (inetgpl::PacketDrillApp) OracleTcpHost.pdhost.tunApp[0] (id=16), at t=1.35s, event #89
...
- kernel source hint: `~/w/kernel/linux-7.2-rc2/net/ipv4/tcp.c`
- message: Datagrams are not the same -- in module (inetgpl::PacketDrillApp) OracleTcpHost.pdhost.tunApp[0] (id=16), at t=1.02s, event #29
...
- kernel source hint: `~/w/kernel/linux-7.2-rc2/net/ipv4/tcp.c`
- message: Datagrams are not the same -- in module (inetgpl::PacketDrillApp) OracleTcpHost.pdhost.tunApp[0] (id=16), at t=1.01s, event #29
...
- kernel source hint: `~/w/kernel/linux-7.2-rc2/net/ipv4/tcp.c`
- message: Datagrams are not the same -- in module (inetgpl::PacketDrillApp) OracleTcpHost.pdhost.tunApp[0] (id=16), at t=1s, event #29
